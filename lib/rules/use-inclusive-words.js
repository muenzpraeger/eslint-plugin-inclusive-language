...
function excludeAllowedTerms(words) {
    return words.filter((word) => {
        ...
        isAllowedTerm = ruleConfig.allowedTerms.find(
            ({ term, allowPartialMatches }) => {
                if (!allowPartialMatches) {
                    return word.toLowerCase() === term;
                }
